...
\clearpage
% \input{../tables/didsugar.tex}
\captionof{table}{Estimates from the baseline DiD specification (Equation \ref{baseline}) using the untaxed counties in the U.S. as the counterfactual. }\label{didsugartable}

\clearpage
% \input{../tables/tableshortrun.tex}
\captionof{table}{Estimates from the baseline DiD specification (Equation \ref{baseline}) using the untaxed counties in the U.S. as the counterfactual. }\label{tableshortrun}
...
\clearpage
\begin{figure}[t]\centering
  \caption{Soda Budget Share} \label{cookzip}
	\includegraphics[width = \textwidth]{../figures/server_output/soda_budget_share.png}
\end{figure}

\clearpage
\begin{figure}[t]\centering
  \caption{Average Price of Soda per Ounce} \label{cookzip}
	\includegraphics[width = \textwidth]{../figures/server_output/soda_price.png}
\end{figure}

\clearpage
\begin{figure}[t]\centering
  \caption{Soda Price Index: CUPI} \label{cookzip}
	\includegraphics[width = \textwidth]{../figures/server_output/cupi_cook_v_noncook_soda.png}
\end{figure}

\clearpage
\begin{figure}[t]\centering
  \caption{Soda Price Index} \label{cookzip}
	\includegraphics[width = \textwidth]{../figures/server_output/price_cook_v_noncook_soda.png}
\end{figure}

\clearpage
\begin{figure}[t]\centering
  \caption{Retail Price Index: Laspeyres} \label{cookzip}
	\includegraphics[width = \textwidth]{../figures/server_output/laspeyres_cook_v_noncook.png}
\end{figure}


\clearpage
\begin{figure}[t]\centering
  \caption{Retail Price Index: CCG} \label{cookzip}
	\includegraphics[width = \textwidth]{../figures/server_output/cupi_cook_v_noncook.png}
\end{figure}
